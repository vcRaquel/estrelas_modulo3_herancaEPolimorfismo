...
public class Main {
    public static void main(String[] args) {
        ...
        Professor professor1 = new Professor("Alan", "12365478", "6546", "idiomas", 1000, "Superior", "Inglês", 50);
        coordenador1.adicionaProfessor(professor1);
        Professor professor2 = new Professor("Gui", "12365445", "6590", "idiomas", 1000, "Superior", "Inglês", 50);
